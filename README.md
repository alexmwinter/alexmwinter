...
I'm a **Cybersecurity Engineer** specializing in adversarial emulation and secure infrastructure architecture. I bridge the gap between offensive security (Purple Team operations) and defensive engineering, designing resilient systems and automating complex security and compliance workflows. 

### What I Do
* **Adversarial Emulation & Purple Teaming:** Assessing enterprise environments, modeling threats, and operationalizing intelligence to harden organizational defenses.
* **Secure Infrastructure Architecture:** Designing and deploying containerized, self-hosted, and cloud-based environments with a security-by-default methodology.
* **Security & Compliance Automation:** Engineering tools to operationalize and streamline frameworks like NIST 800-53, RMF, and FedRAMP.

### Core Technologies & Capabilities
* **Security Operations:** Adversarial Emulation | Purple Teaming | CISSP | Threat Modeling
